...
for k = 1:size(percentages,1) 
    ...
    for j = 1:size(chromosomes, 1)  % Iterate over each chromosome configuration
        ...
        [accuracyFitness, RB_used] = runFLEnviroment_RUCHE_sameDS(currentChromosome, iteration, averagenumber, r,...
            ruche, verboseFL, miniBatchSize, executionEnviroment, AccDevMat, Shuffle, refModelName, directory_RefModel, directory_tempDir, FragSDS, percentages, j);
    end
end
